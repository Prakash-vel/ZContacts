...
class AddContactFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.addButton.setOnClickListener {
            ...
            contactData.contactMail=binding.editTextTextEmailAddress.toString()
            viewModel.repository.addContact(contactData)
    ...
    private fun navigate(selectedId: Long) {
        if (selectedId == 0L) {
            ...
            this.findNavController()
                .navigate(AddContactFragmentDirections.actionAddContactFragmentToDetailFragment())
        }
    }
